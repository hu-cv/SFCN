# SFCN
Hi! You are welcome to visit here! This repository is used to release the code of a novel tracking method called the Sparse Filters-based Convolutional Network (SFCN), which has been proposed in our paper entitled "Learning Sparse Filters-based Convolutional Networks Without Offline Training for Robust Visual Tracking" published in the International journal of Applied Intelligence, available at https://doi.org/10.1007/s10489-025-06350-3. The experimental datasets and results are available from the ﬁrst author (qixu@hhu.edu.cn) upon reasonable request. If you have any problem, please contact qixu@hhu.edu.cn.
